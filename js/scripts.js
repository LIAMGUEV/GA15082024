const requestNotificationPermission = async () =>{
    ...
    throw new Error("No se ha otorgado permiso para notificaciones");
}else{
    new Notification("Hola, mi nimbre es Peter Parker");
}
}
...
function obtenergeolocalizacion(){
    ...
    navigator.geolocation.getCurrentPosition(function(position){
        ...
        enlace.href = `https://www.google.com/maps/?q=${marcador.lat},${marcador.long}`;
        enlace.target = "blank";
